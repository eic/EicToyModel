...
EicVstSteppingAction::EicVstSteppingAction(EicVstDetector *detector, const PHParameters *parameters)
  //: PHG4SteppingAction(PHG4Detector::detector->GetName())
  : PHG4SteppingAction(dynamic_cast<PHG4Detector*>(detector)->GetName())
  , m_Detector(detector)
  , m_Params(parameters)
...
//____________________________________________________________________________..
EicVstSteppingAction::~EicVstSteppingAction()
{
...
bool EicVstSteppingAction::UserSteppingAction(const G4Step *aStep, bool was_used)
{
...
//____________________________________________________________________________..
void EicVstSteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  string hitnodename;
  ...
  else
  {
    ...
    hitnodename = "G4HIT_" + dynamic_cast<PHG4Detector*>(m_Detector)->GetName();
  }
  ...
  if (!m_HitContainer)
  {
    std::cout << "EicVstSteppingAction::SetTopNode - unable to find "
